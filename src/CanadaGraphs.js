...
function CanadaGraph({historyConfirmed}) {
      ...
      // }
      // function canadaDeathChart() {
      //   var date = Object.keys(historyDeaths.Canada.All.dates).reverse();
      //   var data1 = Object.values(
      //     historyDeaths.Canada["Alberta"].dates
      //   ).reverse();
      //   var data2 = Object.values(
      //     historyDeaths.Canada["British Columbia"].dates
      //   ).reverse();
      //   var data3 = Object.values(
      //     historyDeaths.Canada["Manitoba"].dates
      //   ).reverse();
      //   var data4 = Object.values(
      //     historyDeaths.Canada["New Brunswick"].dates
      //   ).reverse();
      //   var data5 = Object.values(
      //     historyDeaths.Canada["Newfoundland and Labrador"].dates
      //   ).reverse();
      //   var data6 = Object.values(
      //     historyDeaths.Canada["Northwest Territories"].dates
      //   ).reverse();
      //   var data7 = Object.values(
      //     historyDeaths.Canada["Nova Scotia"].dates
      //   ).reverse();
      //   var data8 = Object.values(
      //     historyDeaths.Canada["Nunavut"].dates
      //   ).reverse();
      //   var data9 = Object.values(
      //     historyDeaths.Canada["Ontario"].dates
      //   ).reverse();
      //   var data10 = Object.values(
      //     historyDeaths.Canada["Prince Edward Island"].dates
      //   ).reverse();
      //   var data11 = Object.values(
      //     historyDeaths.Canada["Quebec"].dates
      //   ).reverse();
      //   var data12 = Object.values(
      //     historyDeaths.Canada["Yukon"].dates
      //   ).reverse();
...
//           },
//         };
//         var ctx = document.getElementById("canvasCanadaDeaths").getContext("2d");
//         window.myLine = new Chart(ctx, config);
    
//         var colorNames = Object.keys(window.chartColors);
//       }
// this.canadaConfirmedChart();
// this.canadaDeathChart();
